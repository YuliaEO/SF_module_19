...
def test_add_pet_negative_age_number(name='Lisik', animal_type='cat', age='-3', pet_photo='images/lisik.jpg'):
...
def test_add_pet_with_four_digit_age_number(name='Puschistik', animal_type='cat', age='1234', pet_photo='images/puschistik.jpg'):
...
def test_add_pet_with_empty_value_in_variable_name(name='', animal_type='cat', age='2', pet_photo='images/puschistik.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_name(animal_type='cat', age='2', pet_photo='images/Fedor.jpg'):
    ...
    name = 'Паша света оля кристиан олег пионер кузька оран пук лена круассан'
...
def test_add_pet_with_special_characters_in_variable_animal_type(name='Puschistik', age='3', pet_photo='images/puschistik.jpg'):
...
def test_add_pet_with_numbers_in_variable_animal_type(name='Puschistik', animal_type='34562', age='3',
                                                      pet_photo='images/puschistik.jpg'):
...
def test_add_pet_with_a_lot_of_words_in_variable_animal_type(name='Puschistik', age='2', pet_photo='images/puschistik.jpg'):
